...
def runSearch(data, response, spacecraft_frames, t0, background_range, skyResolution=5, skymap=None, \
    ...
    timebins = getTimeBins(data.pha2_data, settings)   # Format: (tstart, duration
    ...
    background_rates = fitBackgrounds(data.pha2_data, time_range=background_range)
    ...
    return {'results': Results.create(results, templates=templates), 't0': t0, 'skymap': skymap,
            'skygrid': skyGrid, 'response': rsp, 'data': data.pha2_data, 'background': background_rates,
