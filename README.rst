...
The Gamma-ray Targeted Search (GTS) is a generalized, mission agnostic, version of the Fermi-GBM Targeted Search that is built around the `Gamma-ray Data Tools <https://astro-gdt.readthedocs.io/en/latest/>`_. 

Installation
------------

To use this code, you will need python3.11 or higher.

If you don't plan to contribute code to the project, the recommended install method is from PyPI using:
...
Example python code for running these searches is included below for developers
